...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas(
      "dino",
      "assets/atlas/sprite.png",
      "assets/atlas/sprite.json"
    );
  ...
  create() {
    ...
    this.dino
      .setSize(this.dino.width * 0.6, this.dino.height * 0.8, false)
      .setOffset(100, 50);
